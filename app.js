...
//  UltraHDR 360° Material Engine — APP.JS
// ============================================================
...
function init() {
    ...
    const loadEnvironment = (resolution, type) => {
    ...
    gui.add(params, 'resolution', ['2k', '4k'])
        .onChange(v => loadEnvironment(v, params.type));
    gui.add(params, 'type', ['HalfFloatType', 'FloatType'])
        .onChange(v => loadEnvironment(params.resolution, v));
    gui.open();
